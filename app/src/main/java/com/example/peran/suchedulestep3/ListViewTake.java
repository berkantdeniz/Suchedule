...
public class ListViewTake extends BaseAdapter {
    ...
    public ListViewTake(Context context, ArrayList<Courses> courseNamesList) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        final ListViewTake.ViewHolder holder;
        if (view == null) {
            holder = new ListViewTake.ViewHolder();
            view = inflater.inflate(R.layout.list_view_reco, null);
            // Locate the TextViews in listview_item.xml
            holder.name = (TextView) view.findViewById(R.id.name);
            view.setTag(holder);
        } else {
            holder = (ListViewTake.ViewHolder) view.getTag();
        }
